...
import { clearStoredSession, getAuthToken, persistAuthToken } from '../session/store'
...
// ---------------------------------------------------------------------------
// Raw HTTP service (internal — used by the public API below)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Public API — high-level auth functions (combine OAuth flows + HTTP calls)
// ---------------------------------------------------------------------------
